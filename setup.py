...
setup(
    ...
    package_data={
        "pycheron": [
            ...
            "test_data/*.w",
            "test_data/*.wfdisc",
            "test_data/.pytest_cache/*.TAG",
            "test_data/.pytest_cache/*.md",
        ...
        "pycheron.dataAcq": ["tests/.pytest_cache/*.TAG", "tests/.pytest_cache/*.md"],
        ...
        "pycheron.util": ["tests/.pytest_cache/*.TAG", "tests/.pytest_cache/*.md"],
    },
    install_requires=[
        "certifi==2019.3.9",
        "cmdline-ispaq",
