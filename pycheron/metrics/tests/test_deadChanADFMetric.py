...
def test_deadChanADFMetric(expected_output, masks_by_time, win_size, gen_masks):
    ...
    metric = deadChanADFMetric(stream, generateMasks=gen_masks, masksByTime=masks_by_time, win_size=win_size)
...
def test_deadChanADFMetricSampleRate(expected_output, sample_rate, p_value, masks_by_time):
    stream = utils.get_stream_from_file("test_data/sglchan_multgap_multoverlap.mseed")
