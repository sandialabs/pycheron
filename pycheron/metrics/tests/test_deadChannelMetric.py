...
expected_output = {
    ...
    "end_time": "2012-12-12T00:59:59.988400",
}


def test_deadChannelMetric():
    st = utils.get_stream_from_client("AK", "GHO", "", "BH*", "2012-12-12T00:00:00.000", 60 * 60)
    dc = deadChannelMetric(st)
    assert len(dc) == 3
    utils.compare_dicts(expected_output, dc[0])
