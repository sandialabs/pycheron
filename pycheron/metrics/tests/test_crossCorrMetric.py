...
def test_crossCorrMetric(filter, expected_output, corners, freq_max, freq_min, max_order):
    st1 = utils.get_stream_from_client("NM", "SLM", "00", "BHZ", "2013-11-12T07:09:45.000", 600)
    st2 = utils.get_stream_from_client("NM", "SLM", "00", "BHZ", "2013-11-12T07:09:48", 600)
    tr1 = st1[0]
    tr2 = st2[0]
