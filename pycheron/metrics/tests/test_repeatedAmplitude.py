...
def test_repeatedAmplitudes():
    st0 = utils.get_stream_from_client("AK", "GHO", "", "BHN", "2012-12-12T00:00:00.000", 60 * 60 * 24)
    st = utils.get_stream_from_client("IU", "ANMO", "00", "BHZ", "2010-02-27T06:16:15.000", 60 * 60 * 24)
