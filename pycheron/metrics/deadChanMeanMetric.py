...
def deadChanMean(
    ...
    :param win_size: number of samples to use for windowing. When None, determines the number of samples to use based on the sample rate
    :type win_size: int
    :param threshold: threshold to trigger deadChan for within rolling window. Recommended to keep this default value for triggered a dead channel
    :type threshold: int
