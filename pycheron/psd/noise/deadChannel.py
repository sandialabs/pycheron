...
def DDT(tr, detrend=True, demean=True, taper=0.1):
    ...
    **Plotting**
    ...
    .. code-block:: python
        ...
        ax1.hlines(y=0,
                   xmin=np.min(tr.times()),
                   xmax=4000,
                   colors='r',
                   linestyles='solid',
                   label='Raw Data Baseline y= 0'
        )
        ax1.legend(loc = 2)
        ...
        ax3.hlines(y=0,
                   ...
                   colors='r',
                   linestyles='solid',
                   label='Raw-DDT Data Baseline y = 0'
        )
        ax3.legend(loc = 2)
    ...
    while True:
        try:
            ...
            # If ObsPy trace, return trace
            if isinstance(tr, obspy.core.trace.Trace):
                return tr
            # If stream object and len = 1, return first trace
...
def isDC(tr, detrend=False, demean=True, taper=0):
    ...
    **Example**
    ...
    # If stream object, try to round to 4 decimal places
    ...
    # Test to see if there are non-zero values in the array or not
