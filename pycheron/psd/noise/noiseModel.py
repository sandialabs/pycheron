...
def noiseModel(freq):
    """
    The noiseModels function returns the New High Noise Model and New Low Noise Model from the 1993 Peterson paper.
    Returned values are based on user specified frequency argument. [#]_ [#]_ [#]_
    ...
    * Code originally ported from IRISSeismic R Cran Package
    ...
    where, T = minimum period" (Callahan, 2020)
    ...
    **Plotting**
    ...
    .. rubric:: References (references from original code base (Callahan, 2020)
    ...
    # calculated from above. Subtract 1 to agree with R code indexing to ensure grabbing the appropriate numbers
    ...
    minPeriod = np.array([0.10, 0.22, 0.32, 0.80, 3.80, 4.60, 6.30, 7.90, 15.40, 20.00, 354.80, 100000])
