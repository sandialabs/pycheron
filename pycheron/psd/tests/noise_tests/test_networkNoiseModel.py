...
def test_networkNoiseModel_e():
    ...
    # Check calculations
    assert out["psdStats"]["noise_matrix_frequency"][0][0][0] == pytest.approx(0.005255602595335718, 0.001)
    assert out["psdStats"]["noise_matrix_frequency"][0][0][-1] == pytest.approx(19.74029856522165, 0.001)
...
def test_networkNoiseModel_e_with_db_arg():
    ...
    # Check calculations
    assert eval(out["psdStats"]["noise_matrix_frequency"][0][0])[0] == pytest.approx(0.005255602595335718, 0.001)
    assert eval(out["psdStats"]["noise_matrix_frequency"][0][0])[-1] == pytest.approx(19.74029856522165, 0.001)
...
def test_networkNoiseModel_z():
    ...
    # Check calculations
    assert out["psdStats"]["noise_matrix_frequency"][0][0][0] == pytest.approx(0.005255602595335718, 0.001)
    assert out["psdStats"]["noise_matrix_frequency"][0][0][-1] == pytest.approx(46.95060701207919, 0.001)
...
def test_networkNoiseModel_e_db():
    ...
    out = networkNoiseModel(db, plot=True, fname="nnm_test", network="7A", station="CABN", channel="BHE")
...
def test_networkNoiseModel_z_db():
    ...
    out = networkNoiseModel(db, plot=True, fname="nnm_test", network="UU", station="ZNPU", channel="HHZ")
    ...
    # Check calculations
    assert eval(out["psdStats"]["noise_matrix_frequency"][0][0])[0] == pytest.approx(0.005255602595335718, 0.001)
    assert eval(out["psdStats"]["noise_matrix_frequency"][0][0])[-1] == pytest.approx(46.95060701207919, 0.001)
