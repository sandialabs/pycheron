...
def frequency_and_spectral_values(file_assets):
    ...
    result = crossSpectrum(test_trace_1, test_trace_2, sampling_rate, spans=np.array([3, 5, 7, 9]))
...
def test_McNamaraBins_returns_two_numpy_arrays_of_floats(align_freq, frequency_and_spectral_values):
